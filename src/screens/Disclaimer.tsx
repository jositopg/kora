      ...
      <div className="w-full max-w-md">
        ...
        <div className="card mb-6">
          <div className="flex items-start gap-3 mb-4">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-sage-600 mt-0.5 shrink-0" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
