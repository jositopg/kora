...
const IconParcelas = (color: string) => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M12 11 L12 2 A9 9 0 0 1 19.79 15.5 Z" fill={color + '35'} stroke={color} strokeWidth="1.4" strokeLinejoin="round"/>
    <path d="M12 11 L19.79 15.5 A9 9 0 0 1 4.21 15.5 Z" fill={color + '22'} stroke={color} strokeWidth="1.4" strokeLinejoin="round"/>
    <path d="M12 11 L4.21 15.5 A9 9 0 0 1 12 2 Z" fill={color + '18'} stroke={color} strokeWidth="1.4" strokeLinejoin="round"/>
  </svg>
)
    ...
    <div className="min-h-screen" style={{ background: 'var(--color-bg)' }}>
      ...
      <main className="px-6 py-8 max-w-2xl mx-auto">
        ...
        <div className="mt-10 flex flex-col items-center gap-2 pb-4">
          <p className="font-sans text-xs text-text-muted" style={{ opacity: 0.5 }}>un espacio creado por</p>
          <a href="https://andreaalvarezpsicologa.es" target="_blank" rel="noopener noreferrer">
            <img
